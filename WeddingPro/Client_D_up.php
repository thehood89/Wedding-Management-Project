    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Update Form For Delux Plan</h2>
                    <form method="POST" action="clientdeluxup.php">
                        ...
                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Wedding Date" id="wedding_date" name="wedding_date">
