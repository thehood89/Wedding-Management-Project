    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
				...
				<h2>Update Entry from Table</h2>
						
					
						<div class="p-t-10">
                            <button class="btn btn--pill btn--green" formaction="Simple_up.php" type="Submit" value="update">Client Simple </button>
                        </div>

                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" formaction="Client_D_up.php" type="Submit" value="update">Client Delux</button>
                        </div>
						
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" formaction="Client_C_up.php" type="Submit" value="update">Client Combo</button>
                        </div>


                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" formaction="Client_L_update.php" type="Submit" value="update">Client Luxury</button>
                        </div>
