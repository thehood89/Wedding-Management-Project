    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Update Form for Simple Plan</h2>
                    <form method="POST" action="clientsimpleup.php">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Name" name="name">
                        </div>

                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Venue" name="venue">
                        <div class="input-group">
<!--  -->               </div>
                        ...
                        <div class="input-group">
                         ...
                         <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="plan" name="plan">
                        </div>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" formaction="Update.php" type="exit">Cancel </button>
                        </div>
                    </form>
                </div>
            </div>
