...
if(mysqli_query($con,"UPDATE `clientdelux` SET `name`='".$name."',`venue`='".$venue."',`band`='".$Band_DJ."',`photographer`='".$photographer."',`decorator`='".$Decorater."',`caterer`='".$Caterer."',`email`='".$email."',`phone`='".$phone."',`wdate`='".$wdate."',`plan`='".$plan."' WHERE '".$name."'"))
{
	echo " Client Updated";
...
mysqli_close($con);
header('Location: Client_D_up.php');
?>
