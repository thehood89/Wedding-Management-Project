...
if(mysqli_query($con,"INSERT INTO `clientcombo`(`name`, `venue`, `band`, `photographer`, `decorator`, `caterer`, `email`, `phone`, `wdate`, `plan`) VALUES ('".$name."','".$venue."','".$Band_DJ."','".$photographer."','".$Decorater."','".$Caterer."','".$email."','".$wdate."','".$phone."','".$plan."')"))
{
...
mysqli_close($con);
header('Location: Client_Combo.php');
