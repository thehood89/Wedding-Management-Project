    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
				...
				<h2>Insertion form for Venue</h2>
					 &nbsp; &nbsp; &nbsp; &nbsp;
					 
					 <form method="POST" action="venue1.php">
                      ...
                      <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Organizer" name="organizer" id="organizer">
                        </div>


                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Wedding Date" name="weddingdate" id="weddingdate">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="textarea" placeholder="Location" name="Location" id="Location">
                        </div>
